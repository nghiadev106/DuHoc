...
namespace DuHoc.Areas.Admin.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        private readonly ICommonCategoryService _categoryNewsService;

        public NewsController(INewsService newsService, ICommonCategoryService categoryNewsService)
        {
        ...
        {
            List<CommonCategory> categories = await _categoryNewsService.GetAll();
            categories.Insert(0, new CommonCategory { Id = -1, Name = "-- Chọn danh mục --" });
